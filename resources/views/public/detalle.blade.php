        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                ...
                <div class="card border-0 shadow-sm rounded-3 p-4 bg-white">
                    ...
                    <p class="text-muted small">Publicado el {{ is_string($post->created_at) ? date('d/m/Y H:i', strtotime($post->created_at)) : $post->created_at->format('d/m/Y H:i') }}</p>
                    <hr>
                            ...
                            @forelse($comentarios as $com)
                                <div class="card p-3 shadow-sm border-0 bg-white rounded-3">
                                    <div class="d-flex justify-content-between align-items-center mb-1">
                                        <span class="fw-bold text-dark"><i class="bi bi-person-circle text-secondary me-1"></i> {{ $com->usuario }}</span>
